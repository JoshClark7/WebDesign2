...
let initMap = () => {
    mapboxgl.accessToken = 'pk.eyJ1Ijoiam9zaHRjbGFyayIsImEiOiJjbGdiM2hrN2cwMDBxM2psOHl6cmE1cnQ4In0.l3b0WTuZTxUobof5W6NKEg';
...
let addMarker = (coordinates, title, description, className) => {
...
export { initMap, loadMarkers, addMarkersToMap, flyTo, setPitchAndBearing, setZoomLevel, addMarker };